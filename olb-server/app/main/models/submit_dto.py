...
class SubmitDto:
    ...
    submit_match_response = namespace.model(
        "submit_match_response",
        {
            "success": fields.Boolean(
                required=True, description="Whether or not the result was successfully submitted"
            ),

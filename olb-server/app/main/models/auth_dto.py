...
class AuthDto:
    ...
    login_user_response = namespace.model(
        "login_user_response",
        {
    ...
    logout_user_response = namespace.model(
        "logout_user_response",
        {
            "success": fields.Boolean(
                required=True, description="Whether or not the user's token was successfully blacklisted"
            ),
            "message": fields.String(required=True, description="Description of success or failure"),
        },
    )

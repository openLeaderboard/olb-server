...
class NotificationDto:
    ...
    incoming_invite = namespace.model("incoming_invite", {
    ...
    outgoing_invite = namespace.model("outgoing_invite", {
        "to_name": fields.String(required=True, description="receiving user's name"),
        "invite_id": fields.Integer(required=True, description="invite's id"),
    })

    incoming_submission = namespace.model("incoming_submission", {
        "from_name": fields.String(required=True, description="sending user's name"),
        "match_id": fields.Integer(required=True, description="match's id"),
    })

    outgoing_submission = namespace.model("outgoing_submission", {
        "to_name": fields.String(required=True, description="receiving user's name"),
        "match_id": fields.Integer(required=True, description="match's id"),
    })

    incoming_invites_response = namespace.model("incoming_invites_response", {
        "invites": fields.List(fields.Nested(incoming_invite))
    })

    outgoing_invites_response = namespace.model("outgoing_invites_response", {
        "invites": fields.List(fields.Nested(outgoing_invite))
    })

    incoming_submissions_response = namespace.model("incoming_submissions_response", {
        "matches": fields.List(fields.Nested(incoming_submission))
    })

    outgoing_submissions_response = namespace.model("outgoing_submissions_response", {
        "matches": fields.List(fields.Nested(outgoing_submission))
    })

    invite_response = namespace.model("invite_response", {
    ...
    submission_response = namespace.model("invite_response", {
        "board_id": fields.Integer(required=True, description="Id of the invite's board"),
        "board_name": fields.String(required=True, description="board's name"),

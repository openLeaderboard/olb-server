...
class UserDto:
    ...
    user_board = namespace.model("user_board", {
    ...
    user_profile_response = namespace.model("user_profile_response", {
        "user_id": fields.Integer(required=True, description="Id of the user being returned"),
        "name": fields.String(required=True, description="User's username"),
        "board_count": fields.Integer(required=True, description="Number of boards the user is an active member of"),
        "matches_count": fields.Integer(required=True, description="Number of verified matches the user was part of"),
        "favourite_boards": fields.List(fields.Nested(user_board))
    })

    user_boards_response = namespace.model("user_boards_response", {
        "boards": fields.List(fields.Nested(user_board))
    })

    user_match = namespace.model("user_match", {
        "board_name": fields.String(required=True, description="board's name"),
    ...
    user_activity_response = namespace.model("user_activity_response", {
        "matches": fields.List(fields.Nested(user_match))
    })

    user_search = namespace.model("user_search", {
